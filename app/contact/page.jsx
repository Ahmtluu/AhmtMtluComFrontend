      ...
      <div className="mt-6 lg:mt-32 mb-16 grid grid-cols-1 gap-12">
        {isSuccessed == true && (
          <div
            ...
            role="alert"
          >
            <span className="font-medium">Teşekkürler!</span> Mesajınız
        ...
        <form onSubmit={handleSubmit(sendEmail)} ref={form} className="">
          <div className="-mx-2 md:items-center md:flex">
            <div className="flex-1 px-2">
              ...
              {errors.user_name?.type === "required" && (
                <p role="alert">Bu alan zorunludur!</p>
              )}
              {errors.message?.type === "minLength" && (
                <p role="alert">Girmeniz gereken minimum karakter sayısı: 5!</p>
              )}
            </div>
          ...
          <div className="w-full mt-4">
            ...
            {errors.message?.type === "minLength" && (
              <p role="alert">Girmeniz gereken minimum karakter sayısı: 25!</p>
            )}
          </div>
          {isSending ? (
            <button
